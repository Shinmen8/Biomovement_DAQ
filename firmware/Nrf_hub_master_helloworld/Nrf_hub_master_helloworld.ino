...
void setup(void)
{
  ...
  radio.begin();                            // initialize nrf24 and configuration
  ...
  radio.openReadingPipe(1, talking_pipes[1]);    // open reading pipes
...
void Serial_data() {   // send data from the serial to the nodes
...
void nrfhub_data() {    // print data from the nodes to the serial input 
